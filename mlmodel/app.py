...
def extract_skills_from_resume(text):
    skills_list = [
        ...
        'Quantum Computing', 'Edge Computing', 'Robotic Process Automation (RPA)', 'Internet of Things (IoT)', '5G Technology', 'DevSecOps', 'Hybrid Cloud', 'Augmented Analytics',
        'Biometric Authentication', '3D Printing', 'Geographic Information Systems (GIS)', 'Digital Twins', 'Swarm Intelligence', 'AI Ethics', 'Zero Trust Security', '5G Networking',
        'Bioinformatics', 'Brain-Computer Interface', 'Electroencephalography (EEG)', 'Functional Magnetic Resonance Imaging (fMRI)', 'Transcranial Magnetic Stimulation (TMS)'
    ]
...
def extract_education_from_resume(text):
    ...
    education_keywords = [
        ...
        'Zoology', 'Quantum Physics', 'Astrophysics', 'Astronomy', 'Marine Biology', 'Oceanography', 'Atmospheric Science', 'Geology', 'Earth Science'
    ]
